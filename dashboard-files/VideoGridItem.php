...
class VideoGridItem {
    ...
    private function createDetails() {
        ...
        $url = "editVideo.php?videoId=" . $this->video->getUniqueID();

        $viewUrl = "watch.php?v=" . $this->video->getUniqueID();
        ...
        return "<div class='details'>
                    ...
                    <ul class='nav'>
                      <li class='nav-item'>
                        <a class='btn btn-info' href='$url' role='button'>Edit Video</a>
                      </li>
                      <li class='nav-item'>
                        &nbsp;<a class='btn btn-success' href='$viewUrl' role='button'>Watch Video</a>
                      </li>
                      <li class='nav-item'>
                        &nbsp;<a href='$url' class='btn btn-danger delete-modal' data-toggle='modal' data-target='.bd-example-modal-lg'>Delete Video</a>
                      </li>
                    </ul>
                </div>
