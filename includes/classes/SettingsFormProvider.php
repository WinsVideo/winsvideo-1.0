...
class SettingsFormProvider {
    ...
    private function createFirstNameInput($value) {
        ...
        return "<div class='form-group'>
                    <input class='form-control' type='text' placeholder='First Display Name' name='firstName' value='$value' required>
                </div>";
    }
    ...
    private function createLastNameInput($value) {
        if($value == null) $value = " ";
        return "<div class='form-group'>
                    <input class='form-control' type='text' placeholder='Last Display Name (Optional)' name='lastName' value='$value'>
                </div>";
    }
