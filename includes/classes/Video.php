...
class Video {
    ...
    public function getUploadedBy() {
        return htmlspecialchars(strip_tags($this->sqlData["uploadedBy"]));
    }

    public function getUploadedByFullName() {
        $uploadedByUsername = $this->sqlData["uploadedBy"];
        if($value == null) $value = "";
        $query = $this->con->prepare("SELECT * FROM users WHERE username='$uploadedByUsername'");    
        $query->execute();

        while($row = $query->fetch(PDO::FETCH_ASSOC)) {
            $id = $row["id"];
            $name = htmlspecialchars(strip_tags($row["firstName"] . " " . $row["lastName"]));
    ...
    public function getTitle() {
        return htmlspecialchars(strip_tags($this->sqlData["title"]));
    }

    public function getDescription() {
        return htmlspecialchars(strip_tags($this->sqlData["description"]));
    }
    ...
    public function getFilePath() {
        return htmlspecialchars(strip_tags($this->sqlData["filePath"]));
    }
    ...
    public function getCategory() {
        ...
        while($row = $query->fetch(PDO::FETCH_ASSOC)) {
            ...
            $html = "<label $selected value='$id'>$name</label>";
        }
