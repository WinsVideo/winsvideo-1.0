...
if (reg.test($('.channelDesc').val()) == true) {

    var ErrorText ='No HTML Tags are allowed';
...
<html>
	...
	Adjust the box by dragging the two lines at the bottom right corner.</p>
		<form action="" method="post" enctype="multipart/form-data">
			<textarea class='channelDesc' type="text" name="text" placeholder="Add Channel Description Here!"></textarea>
