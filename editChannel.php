...
<html>
    ...
    public function create() {
		...
		public function createCoverPhotoSection() { 
			$banner = $this->profileData->getCoverPhoto(); 
				...
				<img class='coverPhoto' style='width: 50%; height=50%; border: 5px solid;' src='$banner'>"; 
		...
		public function createHeaderSection() { 
			...
			<img class='backgroundImage' style='width: 50%; height=50%' src='$background'>"; 
	...
	<hr>
		<button class="btn btn-primary" onclick="window.location.href = 'profilePicture.php';">Edit Profile Picture</button>
	...
	?> 
	<br><br>
	<button class="btn btn-primary" onclick="window.location.href = 'channelBackground.php';">Edit Channel Background</button>
	<br>
		
		<h3>Upload Banner Image</h3>
	<p>Upload Banner, by clicking the Banner Picture button</p>
	<hr>
		<button class="btn btn-primary" onclick="window.location.href = 'bannerPicture.php';">Edit Banner Picture</button>
				<br>
	...
	<hr>
		<button class="btn btn-primary" onclick="window.location.href = 'channelDescription.php';">Edit Channel Description</button>
				<br>
	...
	<hr>
		<button class="btn btn-primary" onclick="window.location.href = 'country.php';">Edit Country</button>
				<br>
	...
	<hr>
		<button class="btn btn-primary" onclick="window.location.href = 'addLinks.php';">Edit Links</button>
				<br>
